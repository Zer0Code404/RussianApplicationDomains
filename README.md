...
Если вы знаете сервисы, которые блокировали VPN-подключения у себя на сайте или передают данные Роскомнадзору - смело пишите в Issue.
Ваша информация поможет многим пользователям VPN оставатся в безопасности.
